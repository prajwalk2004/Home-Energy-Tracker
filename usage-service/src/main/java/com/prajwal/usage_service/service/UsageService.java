package com.prajwal.usage_service.service;
...
import com.prajwal.usage_service.client.DeviceClient;
import com.prajwal.usage_service.client.UserClient;
import com.prajwal.usage_service.dto.DeviceDto;
import com.prajwal.usage_service.dto.UserDto;
import com.prajwal.usage_service.kafka.event.AlertingEvent;
import com.prajwal.usage_service.kafka.event.EnergyUsageEvent;
import com.prajwal.usage_service.model.DeviceEnergy;
        ...
        for(DeviceEnergy deviceEnergy:deviceEnergies){
            try {
                ...
                if(deviceResponse == null || deviceResponse.id() == null){
                   log.info("device not found with this id :{}" ,deviceEnergy.getDeviceId());
                   continue;
                }
                deviceEnergy.setUserId(deviceResponse.userId());
            } catch (Exception e) {
               log.warn("faild to featchd device by id :{}",deviceEnergy.getDeviceId());
            }
        }
